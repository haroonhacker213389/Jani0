...
def reg():
    ...
    try:
        ...
        reg2()
    r = requests.get('https://raw.githubusercontent.com/haroonhacker213389/Jani/main/1.txt').text
    if to in r:
        time.sleep(2)
        bsn_menu()
    else:
...
def bsn_menu():
    ...
    print(" [*]. Tysm To My All Frendz. (Veer Khanoo)");time.sleep (0.03)
    print(" [*] -----------------------------------------------------------------------------------");time.sleep (0.03)
    print(" [*]. VERSION  3.0                                    ");time.sleep (0.03)   
    print(" [*]. WP             +923439635677      ");time.sleep (0.03)
    print(" [*]. This Tool was made in Khattak Saab              ");time.sleep (0.03)
    print(" [*] -----------------------------------------------------------------------------------");time.sleep (0.03)
    print(".[*] ---------------------------------------------");time.sleep(0.03)
